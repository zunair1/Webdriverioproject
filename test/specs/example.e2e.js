...
const verificationpass = require('../pageobjects/verificationcompleted.page');
const allureReporter = require('@wdio/allure-reporter').default

describe('Sauce positive cases', () => {
    it('Login and add item to the cart 1', async () => {
        allureReporter.addFeature("Test Adding item to cart 1")
        allureReporter.addStep("Open the browser 1")
        await LoginPage.open();
        allureReporter.addStep("Enter valid credential to Login 1")
    ...
    it('Go to checkout first page by filling form', async () => {
        ...
        await verificationpass.verifytext();
       })
});
